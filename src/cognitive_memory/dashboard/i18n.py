...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "nav.crystallization": {"en": "Crystallization", "ja": "記憶の定着"},
    ...
    # Crystallization
    "crystal.title": {"en": "Crystallization", "ja": "記憶の定着"},
    "crystal.subtitle": {"en": "Knowledge crystallization status and extracted patterns", "ja": "記憶への知識定着状況と抽出パターン"},
    "crystal.signals": {"en": "Crystallization Signals", "ja": "定着シグナル"},
    "crystal.signals_desc": {"en": "When enough patterns, errors, and logs accumulate, it's time to extract knowledge. Each row shows how much has built up versus the threshold for crystallization.", "ja": "パターン・エラー・ログが一定量溜まると、知識を抽出するタイミング。各行は現在の蓄積量と定着に必要な閾値を示している。"},
    "crystal.recommended": {"en": "Crystallization recommended", "ja": "定着を推奨"},
    ...
    "crystal.checkpoint_desc": {"en": "Tracks when knowledge was last crystallized and how many times the process has run.", "ja": "最後に知識を定着させた日時と、これまでの実行回数を記録している。"},
    ...
    "crystal.error_patterns_desc": {"en": "Recurring mistakes extracted from session logs. Each pattern has a root cause and a countermeasure to prevent recurrence.", "ja": "セッションログから抽出された繰り返しのミス。それぞれに原因と再発防止策がある。"},
