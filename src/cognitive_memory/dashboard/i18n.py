...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "memory.arousal_desc": {"en": "Distribution of emotional intensity scores (0.0-1.0)", "ja": "情動強度スコアの分布 (0.0-1.0)"},
    "memory.crystallization": {"en": "Crystallization Signals", "ja": "結晶化シグナル"},
    "memory.crystal_desc": {"en": "Conditions for triggering knowledge crystallization", "ja": "知識結晶化のトリガー条件"},
    "memory.crystal_recommended": {"en": "Crystallization recommended", "ja": "結晶化を推奨"},
